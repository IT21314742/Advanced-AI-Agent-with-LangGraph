...
class PromptsTemplates:
    ...
    def reddit_url_analysis_system() -> str:
        ...
        return """You are an expert at analyzing social media content. Your task is to examine Reddit search results and identify the most relevent posts that would provide """